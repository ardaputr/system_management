...
<head>
  ...
  <title>Login | Victory Jaya</title>
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          ...
          <div class="p-5">
            ...
            <div class="new-account">
              <span style="color: rgba(0, 0, 0, 0.54);">Don't have an account?</span>
              <a href="sign-up.php" style="text-decoration: none;"><span style="color: rgba(5, 0, 255, 0.81); font-weight: bold;">Sign Up Now</span></a>
            </div>
            <hr>
          </div>
